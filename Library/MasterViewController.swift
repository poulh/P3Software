...
//  Library
//
//  Created by Poul Hornsleth on 12/8/17.
...
class MasterViewController: UITableViewController {
    ...
    func initIRC()
    {
        ...
        irc?.register("nickname", user: "therick76", realName: "Rick James")
...
extension MasterViewController: GMIRCClientDelegate {
    func didWelcome() {
    ...
    func didJoin(_ channel: String) {
        ...
        self.irc?.sendMessageToNickName("Hi, I'm eugenio_ios. Nice to meet you!", nickName: "eugenio79")
    }
